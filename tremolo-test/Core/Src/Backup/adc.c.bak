...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB11     ------> ADC1_IN14
    */
    HAL_GPIO_DeInit(GPIOC, pAIN_SUBDIV_Pin|pAIN_EXP_Pin|pAIN_TRIM_1_Pin|pAIN_TRIM_2_Pin);

    HAL_GPIO_DeInit(GPIOA, pAIN_RATE_Pin|pAIN_DEPTH_Pin|pAIN_SHAPE_Pin|pAIN_OFFSET_Pin);

    HAL_GPIO_DeInit(pAIN_VOL_GPIO_Port, pAIN_VOL_Pin);
